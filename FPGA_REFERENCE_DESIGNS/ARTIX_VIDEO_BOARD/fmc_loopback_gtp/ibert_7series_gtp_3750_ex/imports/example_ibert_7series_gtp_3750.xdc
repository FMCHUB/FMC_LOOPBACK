...
# file: ibert_7series_gtp_3750.xdc
####################################################################################
##   ____  ____ 
##  /   /\/   /
## /___/  \  /    Vendor: Xilinx
...
##  /   /         Filename : example_ibert_7series_gtp_3750.xdc
## /___/   /\     
## \   \  /  \ 
##  \___\/\___\
##
...
## Refclk constraints
##
create_clock -name gtrefclk0_1 -period 8.0 [get_ports GTREFCLK0P_I[0]]
create_clock -name gtrefclk1_1 -period 8.0 [get_ports GTREFCLK1P_I[0]]
...
##
# GT X0Y4
create_clock -name Q1_RXCLK0 -period 4.267 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[0].u_ch/u_gtpe2_channel/RXOUTCLK}]
set_clock_groups -group [get_clocks Q1_RXCLK0] -asynchronous
create_clock -name  Q1_TX0 -period 4.267 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[0].u_ch/u_gtpe2_channel/TXOUTCLK}]
set_clock_groups -group [get_clocks Q1_TX0] -asynchronous
# GT X0Y5
create_clock -name Q1_RXCLK1 -period 4.267 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[1].u_ch/u_gtpe2_channel/RXOUTCLK}]
set_clock_groups -group [get_clocks Q1_RXCLK1] -asynchronous
# GT X0Y6
create_clock -name Q1_RXCLK2 -period 4.267 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[2].u_ch/u_gtpe2_channel/RXOUTCLK}]
set_clock_groups -group [get_clocks Q1_RXCLK2] -asynchronous
# GT X0Y7
create_clock -name Q1_RXCLK3 -period 4.267 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[3].u_ch/u_gtpe2_channel/RXOUTCLK}]
...
set_property PACKAGE_PIN J20 [get_ports LA01_P]
set_property IOSTANDARD LVCMOS12 [get_ports LA01_P]

set_property PACKAGE_PIN J21 [get_ports LA01_N]
set_property IOSTANDARD LVCMOS12 [get_ports LA01_N]
##
...
##
set_property LOC BUFHCE_X0Y48 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_clocking/local_txusr.u_txusr]
set_property LOC BUFHCE_X0Y49 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_clocking/rx_ind.u_rxusr0]
set_property LOC BUFHCE_X0Y50 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_clocking/rx_ind.u_rxusr1]
set_property LOC BUFHCE_X0Y51 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_clocking/rx_ind.u_rxusr2]
set_property LOC BUFHCE_X0Y52 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_clocking/rx_ind.u_rxusr3]
##
...
set_property RXOUT_DIV 1 [get_cells u_ibert_core/inst/QUAD[0].u_q*/CH[*].u_ch/u_gtpe2_channel]
set_property TXOUT_DIV 1 [get_cells u_ibert_core/inst/QUAD[0].u_q*/CH[*].u_ch/u_gtpe2_channel]
 ##-----------------Eyescan--------------
...
set_property RXCDR_CFG 83'h0001107FE206021041010 [get_cells u_ibert_core/inst/QUAD[0].u_q*/CH[*].u_ch/u_gtpe2_channel]
...
set_property PLL1_FBDIV 3 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_gtpe2_common]
set_property PLL0_FBDIV 3 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_gtpe2_common]
