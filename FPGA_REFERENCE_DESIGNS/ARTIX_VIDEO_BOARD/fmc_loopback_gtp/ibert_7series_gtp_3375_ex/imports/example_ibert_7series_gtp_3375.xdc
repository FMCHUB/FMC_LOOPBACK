...
# file: ibert_7series_gtp_3375.xdc
####################################################################################
##   ____  ____ 
##  /   /\/   /
## /___/  \  /    Vendor: Xilinx
...
##  /   /         Filename : example_ibert_7series_gtp_3375.xdc
## /___/   /\     
## \   \  /  \ 
##  \___\/\___\
##
...
## Refclk constraints
##
create_clock -name gtrefclk0_1 -period 7.408 [get_ports GTREFCLK0P_I[0]]
create_clock -name gtrefclk1_1 -period 7.408 [get_ports GTREFCLK1P_I[0]]
...
##
# GT X0Y4
create_clock -name Q1_RXCLK0 -period 4.741 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[0].u_ch/u_gtpe2_channel/RXOUTCLK}]
set_clock_groups -group [get_clocks Q1_RXCLK0] -asynchronous
create_clock -name  Q1_TX0 -period 4.741 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[0].u_ch/u_gtpe2_channel/TXOUTCLK}]
set_clock_groups -group [get_clocks Q1_TX0] -asynchronous
# GT X0Y5
create_clock -name Q1_RXCLK1 -period 4.741 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[1].u_ch/u_gtpe2_channel/RXOUTCLK}]
set_clock_groups -group [get_clocks Q1_RXCLK1] -asynchronous
# GT X0Y6
create_clock -name Q1_RXCLK2 -period 4.741 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[2].u_ch/u_gtpe2_channel/RXOUTCLK}]
set_clock_groups -group [get_clocks Q1_RXCLK2] -asynchronous
# GT X0Y7
create_clock -name Q1_RXCLK3 -period 4.741 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[3].u_ch/u_gtpe2_channel/RXOUTCLK}]
...
set_property RX_CLK25_DIV 6 [get_cells u_ibert_core/inst/QUAD[0].u_q*/CH[*].u_ch/u_gtpe2_channel]
...
set_property TX_CLK25_DIV 6 [get_cells u_ibert_core/inst/QUAD[0].u_q*/CH[*].u_ch/u_gtpe2_channel]
